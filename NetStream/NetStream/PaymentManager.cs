...
namespace NetStream
{
    public class PaymentManager
    {
        ...
        public static void Initialize()
        {
            try
            {
                URL = NetStreamEnvironment.GetRequiredString("NETSTREAM_BTCPAY_URL", "BTCPay server URL");
                API_KEY = NetStreamEnvironment.GetRequiredString("NETSTREAM_BTCPAY_API_KEY", "BTCPay API key");
                STORE_ID = NetStreamEnvironment.GetRequiredString("NETSTREAM_BTCPAY_STORE_ID", "BTCPay store id");
